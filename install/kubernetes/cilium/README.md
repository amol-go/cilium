...
| nodeinit.securityContext | object | `{"capabilities":{"add":["SYS_MODULE"]},"privileged":false,"seLinuxOptions":{"level":"s0","type":"spc_t"}}` | Security context to be added to nodeinit pods. |
